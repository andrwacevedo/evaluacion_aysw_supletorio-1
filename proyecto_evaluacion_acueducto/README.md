...
| Carpeta | Qué es |
|---|---|
| [`EVALUACION_INDIVIDUAL.md`](EVALUACION_INDIVIDUAL.md) | **El enunciado** |
| [`RESPUESTAS.md`](RESPUESTAS.md) | **Las diez preguntas** — 35 % |
| `db/bdacueducto.sql` | La base, **dada y probada** |
| `api_acueducto/` | Cada carpeta con su `LEAME.md` |
...
2. Lea [`EVALUACION_INDIVIDUAL.md`](EVALUACION_INDIVIDUAL.md) —
